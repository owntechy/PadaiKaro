                ...
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        <div class="card-header align-items-center d-flex">
                            <h4 class="mb-0 card-title flex-grow-1">Add Course</h4>
                        ...
                        <div class="card-body">
                            <div class="live-preview">
                                <form action="{{route('createcourseregistration')}}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    <div class="row gy-4">
                                        ...
                                        <div class="col-lg-2 col-md-6">
                                            <div>
                                                ...
                                                <input type="text" class="form-control" id="placeholderInput"
                                                    placeholder="enter course name" name="courseactualname">
                                            </div>
                                        </div>
                                        <div class="col-lg-2 col-md-6">
                                            <div>
                                                ...
                                                <input type="text" class="form-control" id="placeholderInput"
                                                    placeholder="enter course duration" name="duration">
                                            </div>
                                        </div>
                                        <div class="col-lg-2 col-md-6">
                                            <div>
                                                ...
                                                <input type="text" class="form-control" id="placeholderInput"
                                                    placeholder="enter course fees" name="fees">
                                            </div>
                                        </div>
                                        <div class="col-lg-3 col-md-6">
                                            <div>
                                                ...
                                                <input type="file" class="form-control" id="placeholderInput"
                                                    placeholder="upload logo" name="courselogo">
                                            </div>
                                        </div>
                                        <div class="col-xxl-12 col-md-6">
                                            <div>
                                                <label for="exampleFormControlTextarea5" class="form-label">Discription</label>
                                                <textarea name="coursediscription" class="form-control" id="exampleFormControlTextarea5" rows="3"></textarea>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="card-footer">
                                        <button type="submit" class="btn btn-success waves-effect waves-light float-end">Add</button>
                                    </div>
                                </form>
                            </div>
                        </div>
