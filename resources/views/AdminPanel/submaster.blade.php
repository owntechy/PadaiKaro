                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header align-items-center d-flex">
                            <h4 class="mb-0 card-title flex-grow-1">Add Submaster</h4>
                                ...
                                <div class="row gy-4">
                                    <div class="col-xxl-3 col-md-6">
                                        <div>
                                            ...
                                            <select name="type" class="mb-3 form-select" aria-label="Default select example" id="subcategory">
                ...
                success: function(data) {
                    ...
                    data.forEach(function(element, index) {
                        ...
                        row += '<td class="align-middle white-space-nowrap pe-0">' +
                            '<a href="/deletemastercat/'+ element.id +'/subcatpage"><button type="button"class="btn btn-outline-danger btn-sm">delete</button></a>' +
                            '</td>';
                        row += '</tr>';
